...
import zyh.com.model.orderfragmodel.TakeOrderModel;

//确认收货presenter层
public class TakeOrderPresenter extends BasePresenter<BaseContract.BaseView> implements BaseContract.BasePresenter {

    private TakeOrderModel takeOrderModel;

    public TakeOrderPresenter(BaseContract.BaseView view) {
        super(view);
    }
    ...
    public void requestData(Object... args) {
        ...
        takeOrderModel.requestData(args)
